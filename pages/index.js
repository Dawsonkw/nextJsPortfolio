      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className=' min-h-screen'>
          ...
          <div className='text-center p-10'>
            ...
            <h3 className='text-2xl py-2 md:text-3xl'>Frontend developer and designer</h3>
        ...
        <section>
          ...
          <div className='lg:flex gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white' >
              <Image className="right-5" src={kitsune} class='object-none object-center m-auto'/>
              <h3 className='text-lg font-medium pt-8 pb-2'>Beautiful and Responsive Design</h3>
              <p>Creating elegant and highly responsive designs for whatever project you may have in mind. 
              </p>
              <h4 className='text-teal-600'>Technologies I work with</h4>
            ...
            <Image src={kitsune} class='object-none object-center m-auto'/>            
              <h3 className='text-lg font-medium pt-8 pb-2'>Brazilian Jiu Jitsu Lessons</h3>
          ...
          <div>
            ...
            <div className='flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
              <div className='basis-1/3 flex-1'>
                <h3 className='text-xl text-teal-600'>JS based To Do List Creator</h3>
                <Image src={port4} className="rounded-lg object-cover"width={'100%'} height={'100%'}/>
                <a href="https://github.com/Dawsonkw/jsToDoList">Code</a>
              </div>
              <div className='basis-1/3 flex-1'>
                <h3 className='text-xl text-teal-600'>Pokedex</h3>
                <Image src={port2} className="rounded-lg object-cover"width={'100%'} height={'100%'}/>
                <a href="https://github.com/Dawsonkw/pokedex">Code</a>
              </div>
              <div className='basis-1/3 flex-1'>
                <h3 className='text-xl text-teal-600'>Simple JS CLock App</h3>
                <Image src={port1} className="rounded-lg object-cover"width={'100%'} height={'100%'}/>
                <a href="https://github.com/Dawsonkw/jsClock">Code</a>
              </div>
              <div className='basis-1/3 flex-1'>
                <h3 className='text-xl text-teal-600'>JS Astronomy Picture of the Day App</h3>
                <Image src={port3} className="rounded-lg object-cover"width={'100%'} height={'100%'}/>
                <a href="https://github.com/Dawsonkw/nasaAPODapp">Code</a>
              </div>
            </div>
          </div>
        </section>
